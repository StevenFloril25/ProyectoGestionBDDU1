...
if (isset($_GET["id"])) {
    $id_catequista = $_GET["id"];
    $conexion = Cconexion::ConexionBD();

    if ($conexion) {
        $sql = "SELECT * FROM Catequista WHERE id_catequista = ?";
        $stmt = $conexion->prepare($sql);
        $stmt->bindParam(1, $id_catequista, PDO::PARAM_INT);
        $stmt->execute();
...
<body>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Editar</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container">
            ...
            <form id="editar-catequista-form" action="catequista.php" method="POST" class="col-md-6 mx-auto">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" id="id_iglesia" name="id_iglesia" class="form-control"
