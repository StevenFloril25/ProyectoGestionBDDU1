    ...
    <div class="spinner-border text-primary" style="width: 3rem; height: 3rem;" role="status">
            ...
            <div class="container py-5">
                <div class="row justify-content-center">
                    <div class="col-lg-10 text-center">
                        <h1 class="display-3 text-white animated slideInDown">Edición de Matrícula</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
            <div class="container">
                ...
                <form id="editar-form" action="matriculas.php" method="POST" class="col-md-6 mx-auto">
                    <input type="hidden" name="id_niño" value="<?php echo $fila['id_niño']; ?>">
                    <div class="row mb-3">
                        <div class="col-md-6">
